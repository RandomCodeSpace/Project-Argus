...
OtelContext is a self-hosted OTLP observability platform. Single binary with embedded React frontend.
- **Backend:** Bun + Hono + Drizzle ORM + bun:sqlite (TypeScript rewrite of original Go backend)
