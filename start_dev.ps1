# ARGUS V5.4 Development Startup Script
...
Write-Host " ARGUS V5.4 (DEV MODE)" -ForegroundColor Cyan
...
# 1. Argus Backend (UI is embedded Go templates — no separate frontend process needed)
Write-Host "[1/1] Starting Argus Backend..." -ForegroundColor Green
...
Write-Host "================================" -ForegroundColor Green
Write-Host ""
Write-Host "  Argus UI:           http://localhost:8080" -ForegroundColor White
